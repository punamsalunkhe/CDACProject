...
public class PetServiceImpl implements IPetService {
	...
	public Pet createPet(String name, String species, String breed, int age, String color, String gender,
        ...
        System.out.println("in pet service:"+userId);
        if (userId != null) {
            Shelter shelter = shelterRepository.findByUserId(userId);
            System.out.println("in pet service:"+shelter);
            if (shelter != null) {
	...
	@Override
    public Integer findShelterIdByUserId(Integer userId) {
        Shelter shelter = shelterRepository.findByUserId(userId);
        if (shelter == null) {
	...
	@Override
	public Pet getPetByIdnew(Integer petId) {
